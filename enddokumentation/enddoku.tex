...
\end{figure}
Aufgrund der Sonderheiten von LabView wurde die Software mit vielen verschiedenen Task ausgestattet. So ist jede GUI komponente, welche auf dem Hauptprogramm aufrufbar ist ein eigener Thread. Die Gui Komponenten werden in den Entsprechenden Zeitpunken dynamisch in der Hauptkomponente als Subkomponenten geladen.
